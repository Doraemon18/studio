...
const educationHistory: EducationItem[] = [
  ...
  {
    id: "2",
    institution: "Creane Memo. High School, Gaya",
    degree: "CBSE - Class 12th (Senior Secondary)",
    duration: "Completed 2021",
    description: "Completed my senior secondary education with a focus on science and mathematics, achieving a strong academic record.",
    icon: Building,
  },
  {
    id: "3",
